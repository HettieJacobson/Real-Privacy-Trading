...
Privacy-preserving decentralized trading using FHEVM
...
### Contract File
```
contracts/trading/RealPrivacyTrading.sol
```
...
### Test File
```
test/trading/RealPrivacyTrading.ts
```
